...
async function drawChart(array, enhet = "Vannstand (cm)") {
...
const hovsvannet = {
    ...
    getMax: function(dataInterval = this.data, display){
        ...
        if(display === true){
            document.getElementById("maxRecordTable").innerHTML = "<td>" + currentArray[1] + "cm" + "</td><td style='font-size: 1rem'>" +(new Date(currentArray[0]*1000)).toString().slice(4,24)+"</td>" 
        }
        return currentArray
    },
    getMin: function(dataInterval = this.data, display){
        ...
        if(display === true){
            document.getElementById("minRecordTable").innerHTML = "<td>" + currentArray[1] + "cm" + "</td><td style='font-size: 1rem'>" +(new Date(currentArray[0]*1000)).toString().slice(4,24)+"</td>" 
        }   
        return currentArray
    }
}
...
function getShortArray(dataInterval, enhet = "Vannstand (cm)"){
